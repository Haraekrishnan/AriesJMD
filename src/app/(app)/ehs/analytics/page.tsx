  ...
  return (
    <div className="p-5 md:p-8 max-w-[1600px] mx-auto space-y-8 text-slate-900">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-semibold text-slate-900 normal-case tracking-tight">EHS Analytics</h1>
        ...
        <div className="flex gap-3">
          ...
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold normal-case text-sm tracking-normal h-11 px-8 rounded-xl shadow-lg shadow-emerald-600/10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2 bg-white border-slate-200 shadow-sm rounded-xl">
          <CardHeader>
            <CardTitle className="text-slate-900 text-lg flex items-center gap-2 font-semibold normal-case tracking-tight">
          ...
          <CardContent>
            ...
            <div className="space-y-3 mt-6">
              {dummyStats.map((stat, i) => (
                <div key={i} className="flex justify-between items-center text-sm font-semibold normal-case tracking-normal">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white border-slate-200 p-8 flex items-center gap-6 shadow-sm rounded-xl">
          <div className="bg-emerald-50 p-5 rounded-2xl">
            <Activity className="h-8 w-8 text-emerald-600" />
          </div>
          <div>
            <p className="text-sm font-semibold text-slate-400 normal-case tracking-normal">Safe Work Days</p>
            <p className="text-4xl font-semibold text-slate-900 tracking-normal">452</p>
          </div>
        </Card>
        ...
        <Card className="bg-white border-slate-200 p-8 flex items-center gap-6 shadow-sm rounded-xl">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-400 normal-case tracking-normal">Hazard Ratio</p>
            <p className="text-4xl font-semibold text-slate-900 tracking-normal">0.42</p>
          </div>
        </Card>
        ...
        <Card className="bg-white border-slate-200 p-8 flex items-center gap-6 shadow-sm rounded-xl">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-400 normal-case tracking-normal">Officers</p>
            <p className="text-4xl font-semibold text-slate-900 tracking-normal">24</p>
          </div>
        </Card>
      </div>
    </div>
