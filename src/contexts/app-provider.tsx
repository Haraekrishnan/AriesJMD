...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [branding, setBranding] = useState<BrandingState>({ appName: 'Aries Marine', appLogo: null });
