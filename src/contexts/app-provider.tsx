...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const can: PermissionsObject = useMemo(() => {
    ...
    // Create a proxy to return true if the permission exists, false otherwise
    return new Proxy({} as PermissionsObject, {
      get: (_, prop: string) => permissions.has(prop as Permission),
    });
  }, [user, roles]);
