...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const deletePayment = useCallback((paymentId: string) => {
    ...
    if (paymentToDelete) {
        ...
        addActivityLog(user.id, 'Payment Deleted', `Deleted payment to ${paymentToDelete.paymentTo}`);
    }
