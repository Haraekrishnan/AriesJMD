...
import ForwardManagementRequestDialog from '../requests/ForwardManagementRequestDialog';
...
export default function ViewDirectiveDialog({ isOpen, setIsOpen, directive: initialDirective }: ViewDirectiveDialogProps) {
  ...
  const request = useMemo(() => {
    return managementRequests.find(d => d.id === initialDirective.id) || initialDirective;
  }, [managementRequests, initialDirective]);
            ...
            <div className="flex flex-col gap-4">
              <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                      {canManageStatus && (
                          <Select onValueChange={(value) => handleStatusChange(value as DirectiveStatus)} value={request.status}>
