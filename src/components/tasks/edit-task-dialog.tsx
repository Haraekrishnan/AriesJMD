...
export default function EditTaskDialog({ isOpen, setIsOpen, task }: EditTaskDialogProps) {
  ...
  const PrimaryActions = (
      <div className="w-full space-y-4 mb-8">
          ...
          {taskToDisplay.status === 'Pending Approval' && !isApprover && (
              <div className="bg-[#EFF6FF] border-2 border-[#DBEAFE] rounded-lg p-4 flex items-start gap-4 shadow-sm">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-[95vw] md:max-w-5xl w-full h-auto max-h-[95vh] flex flex-col p-0 overflow-hidden bg-white">
        {/* --- HEADER --- */}
        ...
        {/* --- MAIN BODY: Single Scrollable Area --- */}
