...
export default function PurchaseRegisterList() {
    const { user, purchaseRegisters, vendors, updatePurchaseRegisterPoNumber } = useAppContext();
    ...
    if (purchaseRegisters.length === 0) {
        return <p className="text-center text-muted-foreground py-8">No purchase history found.</p>;
    }
