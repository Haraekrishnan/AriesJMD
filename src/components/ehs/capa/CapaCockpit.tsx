...
export default function CapaCockpit({ observation, onClose }: CapaCockpitProps) {
    ...
    return (
        <div className="fixed inset-0 z-40 flex flex-col bg-[#F3F7FB] text-slate-900 font-sans overflow-hidden">
            ...
            <header className="h-[75px] shrink-0 bg-white border-b border-slate-200 px-8 flex items-center justify-between z-30">
                    ...
                    <div className="min-w-0 text-left">
                        <div className="flex items-center gap-3">
                            ...
                            <Badge variant="outline" className={cn(
                                "font-black uppercase text-[8px] tracking-[0.2em] h-5 px-2 border-2 rounded-sm bg-white",
                            ...
                            <Badge className="bg-slate-900 text-white font-black text-[8px] h-5 uppercase px-2 rounded-sm border-none tracking-widest">{observation.status}</Badge>
                        </div>
                ...
                <div className="flex items-center gap-6 shrink-0">
                    <div className="hidden lg:flex flex-col text-right leading-none">
                        <p className="text-[9px] font-black text-emerald-600 uppercase tracking-[0.3em]">A SAFER WORKPLACE</p>
                        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">ARIES MARINE GROUP</p>
                    </div>
                    <div className="flex gap-2">
                        <Button variant="outline" className="h-9 px-4 rounded border-2 border-slate-200 font-black text-[9px] uppercase tracking-widest gap-2 bg-white hover:bg-slate-50">
            ...
            <section className="h-[75px] shrink-0 bg-white border-b border-slate-200 px-8 flex items-center z-20">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <main className="flex-1 flex flex-col overflow-hidden relative bg-[#F3F7FB]">
                    ...
                    {/* ACTION FOOTER */}
                    <footer className="h-[65px] shrink-0 bg-white border-t border-slate-300 px-8 flex items-center z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.03)]">
