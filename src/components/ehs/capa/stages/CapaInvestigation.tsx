...
export default function CapaInvestigation({ observation, isLocked }: Props) {
    ...
    const wellClasses = "h-14 rounded-none border-2 border-slate-900 bg-slate-50 font-bold text-sm px-5 focus-visible:ring-0 focus-visible:border-[#2563EB] shadow-inner transition-all";
    const areaWell = "min-h-[160px] rounded-none border-2 border-slate-900 bg-slate-50 px-6 py-5 text-sm font-medium leading-relaxed text-slate-900 focus-visible:ring-0 focus-visible:border-[#2563EB] shadow-inner transition-all";
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input disabled={isLocked} type="date" {...register('whenDate')} className={cn(wellClasses, "pl-14")} />
                                </div>
                            </div>
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input disabled={isLocked} type="time" {...register('whenTime')} className={cn(wellClasses, "pl-14")} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <Textarea 
                                ...
                                className={cn(areaWell, "border-l-rose-600 border-l-8")}
                            />
                        </div>
                    </div>
                </div>
