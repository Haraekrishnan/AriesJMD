                        ...
                        <div className="space-y-10">
                            ...
                            <div className="space-y-8">
                                <div className="p-6 rounded-xl bg-slate-50 border border-[#DCE5EF] space-y-4 shadow-inner">
                                    ...
                                    <div className="h-px bg-[#E5EBF2] w-full" />
                                    <div>
                                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Root Cause Identification</p>
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#304B68] ml-1">Effectiveness Verdict <span className="text-red-500">*</span></Label>
                                    <Select 
                                        disabled={isLocked}
                                        value={watch('verdict')}
                                        onValueChange={v => setValue('verdict', v)}
                                    >
                                        <SelectTrigger className="h-[52px] rounded-[10px] border-[#DCE5EF] bg-white px-4 text-[12px] font-bold uppercase text-[#243B53] focus:ring-1 ring-blue-50">
                                ...
                                <div className="space-y-3">
                                    <Label className="flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#304B68] ml-1">
                                        <MessageSquare className="h-4 w-4 text-[#7A9ABB]" />
