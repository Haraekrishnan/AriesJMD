    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <Card className="bg-white border-slate-200 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.03)] overflow-hidden">
                {/* 1. INDUSTRIAL HEADER (MATCHING REFERENCE) */}
                                    ...
                                    <div className="relative">
                                        ...
                                        {canReassign && (
                                            <Button 
                                                variant="outline" 
                                                size="icon" 
                                                className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-blue-600 border-white text-white shadow-sm hover:bg-blue-700"
                ...
                {/* 3. ATTACHMENT ACTION (IF NOT LOCKED) */}
                    ...
                    <div className="px-10 py-8 border-t bg-slate-50/50">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="relative">
                                ...
                                <Button variant="outline" asChild className="h-10 px-6 rounded-xl border-2 font-black uppercase text-[10px] tracking-widest hover:bg-white shadow-sm">
            ...
            {/* --- REASSIGNMENT DIALOG (OLD SCHOOL INDUSTRIAL SEARCH) --- */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-10">
                    <div className="flex items-center gap-3">
                        ...
                        <h4 className="text-[11px] font-black uppercase tracking-[0.25em] text-slate-500">OPERATIONAL LOGISTICS</h4>
                    </div>
                    ...
                    <div className="space-y-8 text-left">
                        ...
                        {extractedEvidenceUrl && (
                            <div className="space-y-3">
                                ...
                                <div className="h-48 w-72 rounded-xl border-2 border-slate-200 bg-white overflow-hidden relative group/img cursor-zoom-in shadow-sm" onClick={() => onViewImage(extractedEvidenceUrl)}>
