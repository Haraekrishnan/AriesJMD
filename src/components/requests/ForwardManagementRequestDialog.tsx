                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        {possibleRecipients.map(u => <SelectItem key={u.id} value={u.id} disabled={u.status === 'locked'}>{u.name} ({u.role}) {u.status === 'locked' && <span className="text-muted-foreground">(Locked)</span>}</SelectItem>)}
                      </SelectContent>
                    </Select>
                  )}
                />
