    ...
    const handleImport = () => {
        ...
        reader.onload = (e) => {
            try {
                ...
                toast({ title: 'Update Complete', description: `${updatedCount} items were successfully updated.` });
                setIsOpen(false);
            } catch (error) {
    ...
    return (
        ...
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    Upload an Excel file to update items in bulk. Items are matched by the unique <strong>SERIAL NUMBER</strong>.
                </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
                <Alert>
                    ...
                    <AlertDescription>
                        <p className="mb-2">The first row of your Excel sheet must be the header row. Only include columns for fields you want to update. The <strong>SERIAL NUMBER</strong> column is mandatory for matching.</p>
                        <ul className="list-disc list-inside text-xs space-y-1">
                            ...
                            <li><b>PROJECT</b> (Exact name, e.g., "Aries I", "Aries II")</li>
            ...
            <Button onClick={handleImport} disabled={!file}><Upload className="mr-2 h-4 w-4"/> Update Items</Button>
            </DialogFooter>
        </DialogContent>
        </Dialog>
    );
