                                ...
                                return (
                                    ...
                                    {isExpanded && (
                                      <TableRow>
                                          <TableCell
                                              colSpan={3}
                                              className="sticky left-0 z-20 bg-muted/50 border-r"
                                              style={{ left: 0 }}
                                          >
...
take drag & copy function from the earlier job record sheet component, i have given the code here, dont take anything else, just this
