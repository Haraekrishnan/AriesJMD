...
export default function AddOtherEquipmentDialog({ isOpen, setIsOpen }: AddOtherEquipmentDialogProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Add Other Equipment</DialogTitle>
                    <DialogDescription>
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" onClick={handleSubmit}>Add Equipment</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
