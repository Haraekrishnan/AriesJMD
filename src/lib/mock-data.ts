...
export const ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'manage_inward_outward', 'create_jms', 'manage_jms_builder'
    ],
    isEditable: false,
  },
  {
  ...
  },
  {
    ...
    permissions: [
        ...
        'manage_ppe_request', 'view_internal_store_request', 'manage_store_requests',
        'manage_job_record', 'view_inventory', 'create_jms', 'manage_jms_builder'
    ],
    isEditable: true,
  }
];
...
export const OBSERVATION_REPORTS: ObservationReport[] = [];
